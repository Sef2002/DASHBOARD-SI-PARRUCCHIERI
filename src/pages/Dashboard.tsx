...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="h-full space-y-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#7AC143] mb-2">Buongiorno, Pietro</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 bg-[#7AC143] rounded-xl">
          ...
          <p className="text-3xl font-bold text-[#7AC143]">{todayStats.appointments}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-[#7AC143]">€{todayStats.revenue}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-[#7AC143]">{todayStats.newClients}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-3xl font-bold text-[#7AC143]">{todayStats.occupancyRate}%</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-[#7AC143]">Prossimi Appuntamenti</h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-[#7AC143]">Staff Oggi</h2>
              <button className="text-sm text-black hover:text-gray-600 font-medium transition-colors">
                Gestisci Staff →
              </button>
            </div>
              ...
              {staffToday.map((staff, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center">
                    <div className="h-12 w-12 rounded-full bg-[#7AC143] flex items-center justify-center text-white font-bold">
                      {staff.name[0]}
                    </div>
                    <div className="ml-4">
                      <p className="font-semibold text-[#7AC143]">{staff.name}</p>
                      <p className="text-sm text-gray-500">{staff.appointments} appuntamenti</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-[#7AC143]">€{staff.revenue}</p>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-[#7AC143]">Servizi Popolari</h2>
            ...
            <div className="space-y-4">
              {popularServices.map((service, index) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                  <div>
                    <p className="font-semibold text-[#7AC143]">{service.name}</p>
                    <p className="text-sm text-gray-500">{service.bookings} prenotazioni</p>
                  </div>
                  <p className="font-bold text-[#7AC143]">€{service.revenue}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-[#7AC143]">Prodotti in Esaurimento</h2>
            ...
            <div className="space-y-4">
              {lowStockProducts.map((product, index) => (
                <div key={index} className="flex justify-between items-center p-3 bg-red-50 rounded-xl border border-red-100">
                  <div>
                    <p className="font-semibold text-[#7AC143]">{product.name}</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-[#7AC143]">Promozioni Attive</h2>
              ...
              {activePromotions.map((promo, index) => (
                <div key={index} className="p-3 bg-gray-50 rounded-xl">
                  <div className="flex justify-between items-start mb-2">
                    <p className="font-semibold text-[#7AC143]">{promo.name}</p>
                    <span className="text-sm font-bold text-[#7AC143]">{promo.discount}</span>
                  </div>
                  <code className="text-xs bg-[#7AC143] text-white px-2 py-1 rounded font-mono">{promo.code}</code>
                </div>
              ))}
            </div>
          </div>
